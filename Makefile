...
# Generated by qmake (2.01a) (Qt 4.8.1) on: Wed Aug 31 12:51:16 2016
...
INCPATH       = -I/usr/share/qt4/mkspecs/linux-g++ -I. -I/usr/include/qt4/QtCore -I/usr/include/qt4/QtGui -I/usr/include/qt4 -I. -Icore -Igui -Imain -Imain_server -I.
LINK          = g++
LFLAGS        = -Wl,-O1
...
SOURCES       = core/client.cpp \
		...
		main_server/user_info.cpp moc_dispatcher.cpp \
		moc_server.cpp \
...
dist: 
	...
	$(COPY_FILE) --parents $(SOURCES) $(DIST) .tmp/Messenger1.0.0/ && $(COPY_FILE) --parents core/client.hpp core/dispatcher.hpp core/main_client.hpp core/server.hpp core/user.hpp gui/log_in_window.h gui/messenger_window.h main/messenger.h main_server/server.hpp main_server/user_info.hpp .tmp/Messenger1.0.0/ && $(COPY_FILE) --parents core/client.cpp core/dispatcher.cpp core/main_client.cpp core/server.cpp gui/log_in_window.cpp gui/messenger_window.cpp main/main.cpp main/messenger.cpp main_server/main.cpp main_server/server.cpp main_server/user_info.cpp .tmp/Messenger1.0.0/ && (cd `dirname .tmp/Messenger1.0.0` && $(TAR) Messenger1.0.0.tar Messenger1.0.0 && $(COMPRESS) Messenger1.0.0.tar) && $(MOVE) `dirname .tmp/Messenger1.0.0`/Messenger1.0.0.tar.gz . && $(DEL_FILE) -r .tmp/Messenger1.0.0
...
main.o: main_server/main.cpp main_server/server.hpp \
		main_server/user_info.hpp
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o main.o main_server/main.cpp

server.o: main_server/server.cpp main_server/server.hpp \
		main_server/user_info.hpp
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o server.o main_server/server.cpp

user_info.o: main_server/user_info.cpp main_server/user_info.hpp
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o user_info.o main_server/user_info.cpp
