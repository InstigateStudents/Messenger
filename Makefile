...
# Generated by qmake (2.01a) (Qt 4.8.1) on: Wed Aug 24 16:21:31 2016
...
INCPATH       = -I/usr/share/qt4/mkspecs/linux-g++ -I. -I/usr/include/qt4/QtCore -I/usr/include/qt4/QtGui -I/usr/include/qt4 -I. -Igui -Imain -I.
LINK          = g++
LFLAGS        = -Wl,-O1
...
SOURCES       = gui/log_in_window.cpp \
		...
		main/main.cpp \
		main/messenger.cpp moc_log_in_window.cpp \
		moc_messenger_window.cpp \
		moc_messenger.cpp
OBJECTS       = log_in_window.o \
		messenger_window.o \
		main.o \
		messenger.o \
		moc_log_in_window.o \
...
dist: 
	...
	$(COPY_FILE) --parents $(SOURCES) $(DIST) .tmp/Messenger1.0.0/ && $(COPY_FILE) --parents core/dispatcher.hpp gui/log_in_window.h gui/messenger_window.h main/messenger.h .tmp/Messenger1.0.0/ && $(COPY_FILE) --parents gui/log_in_window.cpp gui/messenger_window.cpp main/main.cpp main/messenger.cpp .tmp/Messenger1.0.0/ && (cd `dirname .tmp/Messenger1.0.0` && $(TAR) Messenger1.0.0.tar Messenger1.0.0 && $(COMPRESS) Messenger1.0.0.tar) && $(MOVE) `dirname .tmp/Messenger1.0.0`/Messenger1.0.0.tar.gz . && $(DEL_FILE) -r .tmp/Messenger1.0.0
...
compiler_moc_header_make_all: moc_log_in_window.cpp moc_messenger_window.cpp moc_messenger.cpp
compiler_moc_header_clean:
	-$(DEL_FILE) moc_log_in_window.cpp moc_messenger_window.cpp moc_messenger.cpp
